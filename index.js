// index.js (Final Version with Automated Reference Submission)
...
async function handleMessage(sender_psid, webhook_event) {
    ...
    if (isAdmin) {
        ...
        if (state) {
            switch (state) {
                case 'awaiting_mod_confirmation': return userHandler.handleModConfirmation(sender_psid, messageText, sendText);
                case 'awaiting_mod_clarification': return userHandler.handleModClarification(sender_psid, messageText, sendText);
