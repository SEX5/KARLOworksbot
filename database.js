// database.js (Final Corrected Version with db.sync() for Persistence)
...
function getDb() {
    if (!db) {
        ...
        db.sync(); // Perform the initial sync when connecting
...
// --- Helper Functions (Now with db.sync() for every operation) ---
